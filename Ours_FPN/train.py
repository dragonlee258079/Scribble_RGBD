...
def main(args):
    ...
    for epo in range(max_epoches):
        ...
        for iteration, data in enumerate(data_loader_train):
            ...
            # gray = F.interpolate(gray, size=sal.size()[2:], mode="bilinear")]
            ...
            loss = rgb_pce + dep_pce + rgbd_pce + 0.7*picked_rgbd_pseudo_loss + 0.6*picked_pseudo_loss + 1.2*JS_loss_mean + 0.3*lsc_loss
