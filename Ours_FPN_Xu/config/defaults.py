...
_C.DATASET = CN()
_C.DATASET.SCALE_SIZE = 288
_C.DATASET.TARGET_SIZE = 256
...
_C.SOLVER.STEPS = (50000, 80000)
_C.SOLVER.MAX_ITER = 100000
_C.SOLVER.MAX_EPOCHES = 130
_C.SOLVER.CON_THRESH_INIT = 0.7
_C.SOLVER.CON_THRESH_FINAL = 0.9
_C.SOLVER.SMALL_LOSS_INIT = 0.7
_C.SOLVER.SMALL_LOSS_FINAL = 0.9
_C.SOLVER.NUM_GRADUAL = 20


_C.NETWORK = CN()
_C.NETWORK.ResNet_CHANNELS = [64, 256, 512, 1024, 2048]
_C.NETWORK.Convert_CHANNELS = [128, 256, 256, 512, 512]
_C.NETWORK.UNIFIY_CHANNELS = 128
