function plotFigure(datasetName,allModel,results, NT)
    recall=[];
    pre=[];
    for modelIdx=1:length(allModel)
        ...
        if strcmp(modelName,results(modelIdx).modelName)
            if ~isempty(results(modelIdx).Performance)
                ...
                recall=[recall,linspace(0.01,1,NT)'];
                pre=[pre,linspace(1,0.01,NT)'];
            end
        else
    ...
    colors={[1 0 0],[0.749019622802734 0.749019622802734 0],[0 0.498039215803146 0],...
            ...
            [1 1 0],[0 0 0],[1 0.600000023841858 0.7843137383461],...
            [0.231372549019608 0.443137254901961 0.337254901960784],[1 0 1],[0 0.498039215803146 0]};
    ...
    annotation(figure1,'textbox',...
        ...
        'FitBoxToText','off',...
        'LineStyle','none');
    saveas(figure1,['scores/' datasetName '\' datasetName '.fig']);
    close all
